...
public class CalculatorJUnitTests {
    ...
    public void testSubtract() {
        Calculator calculator = new Calculator();
        assertEquals("The subtract result is wrong", -7, calculator.subtract(1, 8));
    ...
    public void testMultiply() {
        Calculator calculator = new Calculator();
        assertEquals("The multiply result is wrong", 36, calculator.multiply(6, 6));
    ...
    public void testDivide() {
        Calculator calculator = new Calculator();
        assertEquals("The divide result is wrong", 5, calculator.divide(25, 5));
