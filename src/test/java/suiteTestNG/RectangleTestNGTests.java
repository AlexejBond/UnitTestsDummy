...
public class RectangleTestNGTests {
    ...
    public void testRectangleLength() {
        ...
        Assert.assertEquals(rectangle.getLength(), 7.7, 0.01, "The length is calculated incorrectly.");
    ...
    public void testRectangleWidth() {
        Rectangle rectangle = new Rectangle(7.7, 8.7);
        Assert.assertEquals(rectangle.getWidth(), 8.7, 0.01, "The width is calculated incorrectly.");
    ...
    public void testRectangleArea() {
        Rectangle rectangle = new Rectangle(7.7, 8.7);
        Assert.assertEquals(rectangle.getArea(), 66.99, 0.01, "The area is calculated incorrectly.");
